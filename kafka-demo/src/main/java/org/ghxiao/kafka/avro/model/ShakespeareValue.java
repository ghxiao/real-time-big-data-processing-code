...
public class ShakespeareValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7313038058494698057L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareValue\",\"namespace\":\"org.ghxiao.kafka.avro.model\",\"fields\":[{\"name\":\"line_number\",\"type\":\"int\",\"doc\":\"The line number for line\"},{\"name\":\"line\",\"type\":\"string\",\"doc\":\"The line from Shakespeare\"}]}");
   ...
   */
  public static org.ghxiao.kafka.avro.model.ShakespeareValue.Builder newBuilder() {
    return new org.ghxiao.kafka.avro.model.ShakespeareValue.Builder();
  }
   ...
   * @return A new ShakespeareValue RecordBuilder
   */
  public static org.ghxiao.kafka.avro.model.ShakespeareValue.Builder newBuilder(org.ghxiao.kafka.avro.model.ShakespeareValue.Builder other) {
    return new org.ghxiao.kafka.avro.model.ShakespeareValue.Builder(other);
  }
   ...
   * @return A new ShakespeareValue RecordBuilder
   */
  public static org.ghxiao.kafka.avro.model.ShakespeareValue.Builder newBuilder(org.ghxiao.kafka.avro.model.ShakespeareValue other) {
    return new org.ghxiao.kafka.avro.model.ShakespeareValue.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.ghxiao.kafka.avro.model.ShakespeareValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.ghxiao.kafka.avro.model.ShakespeareValue other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.line_number)) {
        this.line_number = data().deepCopy(fields()[0].schema(), other.line_number);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ghxiao.kafka.avro.model.ShakespeareValue.Builder setLineNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ghxiao.kafka.avro.model.ShakespeareValue.Builder clearLineNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ghxiao.kafka.avro.model.ShakespeareValue.Builder setLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ghxiao.kafka.avro.model.ShakespeareValue.Builder clearLine() {
      line = null;
